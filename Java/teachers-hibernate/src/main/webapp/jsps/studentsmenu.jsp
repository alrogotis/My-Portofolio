...
<body>
	<div class="center">
        ...
        <div class="search-wrapper">
	        ...
	        <div class="bot-gap">
	            <form method="GET" action="${pageContext.request.contextPath}/searchStudent">
	                <input name="lastname" type="text" class="search rounded" placeholder="Insert students lastname" autofocus/>
	                <br><br>
        ...
        <div class="insert-wrapper">
	        ...
	        <div class="bot-gap">
	            <form method="GET" action="${pageContext.request.contextPath}/insertStudent">
